...
async def reports_index(request: Request):
    return templates.TemplateResponse(request, "reports/index.html", _base_context(request))
...
async def report_executive(request: Request, hours: int = Query(24, ge=1, le=720)):
    ...
    return templates.TemplateResponse(request, "reports/executive.html", ctx)
...
async def report_user_activity(
    ...
    return templates.TemplateResponse(request, "reports/user_activity.html", ctx)
...
async def report_productivity(request: Request, hours: int = Query(24, ge=1, le=720)):
    ctx = _base_context(request)
    ctx["report_hours"] = hours
    return templates.TemplateResponse(request, "reports/productivity.html", ctx)
...
async def report_security(request: Request, hours: int = Query(24, ge=1, le=720)):
    ctx = _base_context(request)
    ctx["report_hours"] = hours
    return templates.TemplateResponse(request, "reports/security.html", ctx)
...
async def report_bandwidth(request: Request, hours: int = Query(24, ge=1, le=720)):
    ctx = _base_context(request)
    ctx["report_hours"] = hours
    return templates.TemplateResponse(request, "reports/bandwidth.html", ctx)
...
async def report_top_users(request: Request, hours: int = Query(24, ge=1, le=720)):
    ctx = _base_context(request)
    ctx["report_hours"] = hours
    return templates.TemplateResponse(request, "reports/top_users.html", ctx)
