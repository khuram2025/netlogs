"""
Policy Builder Service - Generate FortiGate CLI commands from log data.
"""
...
'''
    ...
    def build_policy_from_log(
        ...
        """
        Build FortiGate CLI from a log entry's parsed_data.
        ...
        return cls.build_policy_cli(policy_data, zone_table=zone_table)
