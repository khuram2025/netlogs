...
The full application and appliance source now live in this repository. See [the 0.4.4 release notes](docs/zenshield/RELEASE-0.4.4.md), [integration record](docs/zenshield/INTEGRATION-0.4.0.md), [installation guide](appliance/INSTALLATION.md), [storage guide](appliance/STORAGE.md), and [build guide](docs/zenshield/BUILD.md).

## Install on Ubuntu Server

The current fresh-install baseline is **ZenShield 0.4.4**. Run the signed installer on Ubuntu Server 24.04 amd64:
